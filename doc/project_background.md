...
> 创建日期：2026-09-16
> 更新日期：2026-09-16
> 状态：**归档记录（从 CLAUDE.md 移出，供人查阅，非 agent 开发指令）**
>
> 本文档归档从 CLAUDE.md 精简出的**论证性/历史验证内容**。这些是项目的科学背书与实验记录，有长期追踪价值，但对 AI agent 写代码无操作价值，故从 CLAUDE.md 移出。

---

## 1. 动机与背景（调研结论，详见 plip_md_research_survey.md）
...
## 4. 已验证结论（2026-08-11 实证完成，详见 tpr_to_functional_groups.md）
...
## 5. 相关体系速览（验证用，详细组分表见上级 KRAS_MD/CLAUDE.md）
